...
const FuelLog = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setSuccess(true);
      toast({ title: "Delivery Logged", description: `${form.gallons} gal ${form.fuel_type} — $${totalAmount}` });
      setTimeout(() => {
        setSuccess(false);
        setForm({ customer_id: "", fuel_type: "", gallons: "", price_per_gallon: "", aircraft_tail_number: "", truck_id: "", notes: "" });
      }, 2000);
    }
  };
